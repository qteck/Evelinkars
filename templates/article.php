...
<?php if (isset($_SESSION['fb']['token'])) { ?>            
<form id="comment_form1" action="index.php?page=article.php&id=<?php echo $id; ?>&name=<?php echo $content['title']; ?>#comments-bookmark" method="post" style="padding: 20px">
        ...
        <span>Place of writing:</span> <input type='text' name="place"value="The Earth"><br>
