...
<form action="index.php?page=userAddArticle.php" method="post">
    ...
    Article Content: 
    <textarea name="content" style="width: 100%;height: 300px;"><?php echo !isset($_SESSION['addArticleContent']['content'])?'': $_SESSION['addArticleContent']['content']; ?></textarea><br>
    Place: <input type="text" name="place" value="<?php echo !isset($_SESSION['addArticleContent']['place'])?'': $_SESSION['addArticleContent']['place']; ?>" style="width: 100%;"><br><br>
